exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    return knex('user_events').insert([
      {id: 10000, user_id: 1, event_id: 1},
      {id: 20000, user_id: 2, event_id: 1},
      {id: 30000, user_id: 3, event_id: 1},
      {id: 40000, user_id: 1, event_id: 2},
      {id: 50000, user_id: 2, event_id: 2},
      {id: 60000, user_id: 3, event_id: 2},
      {id: 70000, user_id: 2, event_id: 3}
    ])
  })
  .then(function () {
    return knex('user_event_roles').insert([
      {id: 1, user_event_id: 10000 , role_id: 3},
      {id: 2, user_event_id: 20000 , role_id: 2},
      {id: 3, user_event_id: 30000 , role_id: 1},
      {id: 4, user_event_id: 40000 , role_id: 3},
      {id: 5, user_event_id: 40000 , role_id: 2},
      {id: 6, user_event_id: 40000 , role_id: 1},
      {id: 7, user_event_id: 50000 , role_id: 1},
      {id: 8, user_event_id: 60000 , role_id: 1},
      {id: 9, user_event_id: 70000 , role_id: 2}
    ]);
  })
};