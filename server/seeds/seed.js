...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    return knex('users').insert([
      ...
      {id: 40000, first_name: 'Ryan', last_name: 'Pachune', email: 'rp@email.com', avatar: '/users-avatars/man_2.png', password_digest: bcrypt.hashSync('password', 10), is_host: true},
    ])
  })
  .then(function () {
  ...
  .then(function () {
    return knex('events').insert([
      ...
      {id: 10001, title: 'Rustic Brunch', address: '3314 Panorama Ridge, Whistler, BC V0N 1B3, Canada', neighbourhood:'Whistler', location: (50.106924, -122.967214), event_date: new Date('December 10, 2017 11:00:00'), description: 'We\n’ll set the table, you enjoy the sights and sounds of nature in our very own house away from home' }
